...
const ModifyPassword = (props) => {
  ...
  const requestHandle = (msg) => {
    ...
    message.success(msg)
    props.actions.setModifyPasswordDialogStatus(false)
  }
  ...
  return (
    <Modal
      ...
      onOk={handleOk}
      title='修改密码'
      visible={props.modifyPasswordDialogStatus}
      width={500}
    >
...
const mapStateProps = (state) => {
  return {
    modifyPasswordDialogStatus: state.modifyPasswordDialogStatus,
  }
}
...
export default connect(mapStateProps, mapDispatchToProps)(ModifyPassword)
